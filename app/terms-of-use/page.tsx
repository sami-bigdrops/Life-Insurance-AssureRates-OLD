        ...
        <div className="prose prose-lg max-w-none">
          <div className="space-y-8">
            <section>
              ...
              These Terms of Use apply in connection with any websites, online services, and/or applications owned or operated by AssureRates, (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;), including, without limitation, in connection with:
              <ul className="list-disc list-inside text-sm sm:text-base text-gray-700 leading-relaxed mb-4 space-y-2 ml-4">
                <li>the websites currently located at AssureRates.com and any other website owned by us upon which this Terms of Use is linked (collectively, the &quot;Site&quot;); and</li>
                <li>any other interactive features, widgets, products, services, and resources offered by us and/or our affiliates, distributors, or licensees through, and all other content within, the Site (all of which are collectively referred to as the &quot;Services&quot;).</li>
              </ul>
              </p>
            </section>
            <section>
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#1E3A8A] mb-4">1. General Provisions</h2>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#1E3A8A] mb-4">2. Jurisdiction and Governing Law</h2>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4">
                By entering the Site or using the Services, you acknowledge and agree that they are intended for use only by citizens and residents of the United States of America residing within the United States of America aged 18 years or older and will only be governed according to the laws of the State of California without regard to conflicts of laws principles. If you are not a member of the intended audience (as defined above), you are prohibited from accessing the Site or using the Services in any way, shape or form.
              </p>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#1E3A8A] mb-4">3. Content</h2>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4">
            ...
            <section>
              ...
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4">
                If you create an account, we will assign you, and/or allow you to select, a password within our security guidelines and requirements. You must keep your password confidential, and you may not permit any other person to use your password or your account for any purpose. You will be responsible for all use of your password, including, without limitation, any use by any authorized or unauthorized third party. You must notify us immediately if you believe your password may have been used by any unauthorized person or entity. For security purposes, we recommend you change your password at least once every 12 weeks. Under no circumstance should you respond to a request for your password. Our employees will never ask for your password. You must notify us immediately if you receive such a request. We reserve the right to suspend or terminate your use of the Site/Services with or without notice to you if we believe that your password is being used without permission or otherwise in a manner that may disrupt the Site/Services.
              </p>
            </section>

            <section>
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#1E3A8A] mb-3 sm:mb-4">5. Consent for Communications</h2>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4">
              If you provide your telephone number to us via the Site or Services, you give your electronic signature and consent for us to send you marketing calls/text messages at that number <strong>USING AN AUTODIALER AND/OR PRERECORDED MESSAGES.</strong> You also acknowledge that your consent to receive these marketing communications is not required to purchase any goods or services. STANDARD MESSAGE AND DATA RATES MAY APPLY.
              </p>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4">
              If you provide your telephone number to us via the Site or Services <strong>STRONGLY AND GIVE CONSENT FOR COMMUNICATIONS FROM THIRD PARTIES WITH WHOM WE MAY SHARE YOUR INFORMATION,</strong> you give your electronic signature and consent for us AND SUCH THIRD PARTIES to send you marketing calls/text messages at that number using an autodialer AND/OR PRERECORDED MESSAGES. You also acknowledge that your consent to receive these marketing communications is not required to purchase any goods or services. STANDARD MESSAGE AND DATA RATES MAY APPLY.
              </p>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4">
              ...
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4">
              <strong>Call Recording.</strong> You understand that all calls to or from AssureRates, including, without limitation, Call Transfers, may be monitored or recorded for the purpose of review and analysis by AssureRates. By using our website you consent to this recording and agree to obtain the consent of its agents, employees, contractors, and anyone else who may be recorded on any call to or from AssureRates. Call recordings may be stored and analyzed by AssureRates for an indefinite period of time.
              </p>
            </section>

            <section>
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#1E3A8A] mb-3 sm:mb-4">6. Our Intellectual Property</h2>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#1E3A8A] mb-3 sm:mb-4">7. Digital Millennium Copyright Act Notice</h2>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
              If you believe that any material on the Site/Services infringes your copyright rights, please contact our designated agent for Digital Millennium Copyright Act notices by mailing at <a href="mailto:contact@assurerates.com" className="text-[#1E3A8A] hover:underline font-medium">contact@assurerates.com</a>.
              </p>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4">
              In your notice, please include:
              <ul className="list-disc list-inside text-sm sm:text-base text-gray-700 leading-relaxed mb-4 space-y-2 ml-4">
                <li>Your physical or electronic signature;</li>
                <li>Identification of the copyrighted work you claim to have been infringed, or, if there are multiple copyrighted works, a list of such works;</li>
                <li>Identification of the material that you claim to be infringing, and where the material is located on the Site;</li>
                <li>Your permanent home or business (if applicable) address (no P.O. Boxes, please), telephone number, and email address;</li>
                <li>A statement that you have a good faith belief that use of the material in the manner complained of is not authorized by you or the law; and</li>
                <li>A statement, under penalty of perjury, that the information in your notice is accurate.</li>
              </ul>
              </p>

              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4">
              If the notice is submitted by someone else on your behalf, the notice must also contain a signed and notarized statement, under penalty of perjury, stating that the person submitting the notice is authorized to act on your behalf.
              </p>
            </section>

            <section>
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#1E3A8A] mb-3 sm:mb-4">8. Submissions</h2>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#1E3A8A] mb-4">9. Disclaimers & Limitation of Liability</h2>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#1E3A8A] mb-4">10. Indemnity</h2>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#1E3A8A] mb-4">11. Dispute Resolution</h2>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4">
              ...
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4">
                Any matters submitted to a court for resolution shall be submitted to the state or federal courts of Franklin County, Ohio and all parties agree to the personal jurisdiction thereof.
              </p>
            </section>

            <section>
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#1E3A8A] mb-4">12. Privacy & Security</h2>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#1E3A8A] mb-4">13. Links</h2>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4">
                The Site/Services may contain links to sites or be accessed by links from sites that are owned and operated by independent third parties to which these Terms do not apply. We provide links solely as a convenience and the inclusion of the link does not imply that we endorse or accept any responsibility for the content on those sites. We are not responsible for content including but not limited to claims, representations, warranties, offers, illustrations, names, or endorsements on any other sites. Further, we are not, directly or indirectly, implying any approval, association, sponsorship, endorsement, or affiliation with the linked site, unless specifically stated therein, although any such affiliation may be outdated, so please check directly with us for most current information in this regard. Your linking to any other off-site pages or other sites is at your own risk. We recommend that you review any terms of use statement and privacy policy before using any other linked site, including social media sites.
              </p>
            </section>

            <section>
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#1E3A8A] mb-4">14. Contact Information</h2>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4">
              If you have any questions, complaints, or claims, please mail us at: <a href="mailto:contact@assurerates.com" className="text-[#1E3A8A] hover:underline font-medium">contact@assurerates.com</a>.
              </p>

              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4">
              The Program and all information conveyed by it are provided to you on an &quot;AS-IS&quot; and &quot;AS AVAILABLE&quot; basis, and AT YOUR OWN RISK TO THE FULLEST EXTENT PERMITTED UNDER APPLICABLE LAW. To the fullest extent permitted under applicable law, we disclaim all warranties, whether express or implied, including without limitation, any warranties of title, merchantability, non-infringement and fitness for a particular purpose and all warranties regarding security, currency, correctness, quality, accuracy, completeness, reliability, performance, timeliness, or continued availability. We are not responsible for cellular network or equipment performance, and you release us of any liability for claims based on hardware, software, electronic, network or other communications malfunctions such as incomplete messages, delayed transmissions or any technical difficulty that may limit your ability to send or receive a message.ment and privacy policy before using any other linked site, including social media sites.
              </p>
            </section>
